    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-subscriptionPlanChannels">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($channels as $key => $channel)
                            <tr data-entry-id="{{ $channel->id }}">
                                ...
                                <td>
                                    @foreach($channel->subscription_plans as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-subscriptionPlanChannels:not(.ajaxTable)').DataTable({ buttons: dtButtons })
