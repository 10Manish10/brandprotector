...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} Cron Job
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.crons.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
				...
				<input class="form-control {{ $errors->has('schedule') ? 'is-invalid' : '' }}" type="text" name="schedule" id="schedule" value="{{ old('schedule', '') }}" required>
