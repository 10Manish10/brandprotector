                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clients.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="keywords" id="keywords">{!! old('keywords') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="social_handle" id="social_handle" value="{{ old('social_handle', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="multiple_emails" id="multiple_emails">{!! old('multiple_emails') !!}</textarea>
