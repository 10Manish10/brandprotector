                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.subscriptions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="plan_amount" id="plan_amount" value="{{ old('plan_amount', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="features" id="features">{{ old('features') }}</textarea>
