                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.email-templates.update", [$emailTemplate->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject" id="subject" value="{{ old('subject', $emailTemplate->subject) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="email_body" id="email_body">{!! old('email_body', $emailTemplate->email_body) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\EmailTemplate::PRIORITY_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="priority_{{ $key }}" name="priority" value="{{ $key }}" {{ old('priority', $emailTemplate->priority) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="clients[]" id="clients" multiple required>
                                @foreach($clients as $id => $client)
                                    <option value="{{ $id }}" {{ (in_array($id, old('clients', [])) || $emailTemplate->clients->contains($id)) ? 'selected' : '' }}>{{ $client }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="from_email" id="from_email" value="{{ old('from_email', $emailTemplate->from_email) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="to_email" id="to_email" value="{{ old('to_email', $emailTemplate->to_email) }}" required>
