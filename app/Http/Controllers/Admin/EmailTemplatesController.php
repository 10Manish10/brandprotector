...
class EmailTemplatesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.emailTemplates.index', compact('channels', 'emailTemplates'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.emailTemplates.create', compact('channels'));
    }
    ...
    public function edit(EmailTemplate $emailTemplate)
    {
        ...
        return view('admin.emailTemplates.edit', compact('channels', 'emailTemplate'));
    }
